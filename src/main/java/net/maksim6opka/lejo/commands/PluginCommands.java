...
public class PluginCommands {
    ...
    public PluginCommands(Lejo plugin) {
        this.plugin = plugin;
    }
    ...
    public void registerPluginCommands(){
        plugin.getLifecycleManager().registerEventHandler(LifecycleEvents.COMMANDS, event -> {
            ...
            registrar.register(
                    Commands.literal("lejo")
                            .executes( ctx -> {

                                var sender = ctx.getSource().getSender();

                                String msg = plugin.getConfig().getString("messages.system.info", "Lejo - leave and join message control");
                            ...
                            .then(Commands.literal("reload")
                                ...
                                .executes(ctx -> {
                                    ...
                                    plugin.reloadConfig();
                                    String msg = plugin.getConfig().getString("messages.system.reload", "Lejo reloaded");
                                    sender.sendMessage("§a" + msg);
